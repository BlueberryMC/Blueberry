        ...
        this.listeners
                ...
                .forEach(registeredListener -> {
                    try {
                        ...
                        EventManager.printStackTrace(new EventException("Could not pass event " + event.getEventTypeName() + " to listener " + listenerName + " of mod " + registeredListener.mod().name(), cause));
                    }
                });
    }
}
